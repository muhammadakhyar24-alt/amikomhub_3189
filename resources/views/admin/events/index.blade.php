            ...
            <tbody>
                @if($events->count() > 0)
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td class="p-4 text-indigo-600">{{ $event->category ? $event->category->name : '-' }}</td>
                        ...
                        <td class="p-4 flex gap-2">
                            ...
                            <form action="{{ route('admin.events.destroy', $event->id) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus data acara ini secara permanen?');" style="display:inline;">
                                @csrf
                                @method('DELETE')
                ...
                @else
                <tr>
                    <td colspan="4" class="p-4 text-center text-gray-500">Tidak ada event yang ditemukan</td>
                </tr>
                @endif
            </tbody>
        </table>
